...
async function setupServer() {
  try {
    ...
    await initSecurifyLogs({
      app,
      mongoUri:
        process.env.MONGODB_URI || "mongodb://localhost:27017/securify_demo",
      jwtSecret:
        process.env.SECURIFY_JWT_SECRET ||
    ...
    app.listen(PORT, () => {
      ...
      console.log(
        `📊 SecurifyLogs Dashboard: http://localhost:${
          process.env.DASHBOARD_PORT || 9000
        }`
      );
